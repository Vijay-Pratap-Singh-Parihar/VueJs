...
export default {
  ...
  methods: {
    login(e) {
      ...
      // document.write(this.LoginForm.loginFirstName);
    },
  },
};
</script>
...
<template>
  <div>
    <form @submit.prevent="getFormValue">
      First Name:
      <input type="text" v-model="LoginForm.loginFirstName" name="fname" />
      <br />
      Last Name:
      <input type="text" v-model="LoginForm.loginLastName" name="lname" />
      <br />
      Pin Code:
